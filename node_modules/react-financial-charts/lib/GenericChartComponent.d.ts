...
declare class GenericChartComponent extends GenericComponent {
    static defaultProps: {
        svgDraw: any;
        draw: never[];
        canvasToDraw: (contexts: any) => any;
        clip: boolean;
        edgeClip: boolean;
        selected: boolean;
        disablePan: boolean;
    ...
    static contextTypes: {
        ...
        chartCanvasType: PropTypes.Requireable<string>;
    ...
    preEvaluate(): void;
    shouldTypeProceed(type: any, moreProps: any): boolean;
}
