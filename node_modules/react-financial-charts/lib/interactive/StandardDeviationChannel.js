...
export class StandardDeviationChannel extends React.Component {
    constructor(props) {
        ...
        this.handleDragLineComplete = (moreProps) => {
        ...
        this.handleDragLine = (index, newXYValue) => {
            this.setState({
    ...
    render() {
        ...
        const tempLine = isDefined(current) && isDefined(current.end)
            ? React.createElement(EachLinearRegressionChannel, { interactive: false, x1Value: current.start[0], x2Value: current.end[0], appearance: eachDefaultAppearance, hoverText: hoverTextDefault })
            : null;
