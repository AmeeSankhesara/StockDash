        ...
        this.renderSVG = (moreProps) => {
            ...
            if (line1 !== undefined) {
                ...
                const line = line2 !== undefined
                    ? React.createElement("line", { strokeWidth: strokeWidth, stroke: stroke, strokeOpacity: strokeOpacity, x1: x1, y1: line2.y1, x2: x2, y2: line2.y2 })
                    : null;
                const area = isDefined(line2)
                    ? React.createElement("path", { fill: fill, fillOpacity: fillOpacity, d: getPath(line1, line2) })
                    : null;
                return (React.createElement("g", null,
                    React.createElement("line", { strokeWidth: strokeWidth, stroke: stroke, strokeOpacity: strokeOpacity, x1: x1, y1: y1, x2: x2, y2: y2 }),
                    line,
                    area));
            }
        };
