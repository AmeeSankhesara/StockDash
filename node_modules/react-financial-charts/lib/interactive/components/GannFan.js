        ...
        this.renderSVG = (moreProps) => {
            ...
            return (React.createElement("g", null,
                lines.map((each, idx) => {
                    ...
                    return (React.createElement("line", { key: idx, strokeWidth: strokeWidth, stroke: stroke, strokeOpacity: strokeOpacity, x1: x1, y1: y1, x2: x2, y2: y2 }));
                }),
                pairsOfLines.map(([line1, line2], idx) => {
                    ...
                    ctx.closePath();
                    return (React.createElement("path", { key: idx, stroke: "none", fill: fill[idx], fillOpacity: fillOpacity, d: ctx.toString() }));
                })));
        };
