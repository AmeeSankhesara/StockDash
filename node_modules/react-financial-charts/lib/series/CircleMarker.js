...
export class Circle extends React.Component {
    render() {
        ...
        return (React.createElement("circle", { className: className, cx: point.x, cy: point.y, stroke: stroke, strokeWidth: strokeWidth, fillOpacity: opacity, fill: fill, r: radius }));
    }
}
Circle.defaultProps = {
    stroke: "#4682B4",
...
Circle.drawOnCanvas = (props, point, ctx) => {
    const { stroke = Circle.defaultProps.stroke, fill = Circle.defaultProps.fill, opacity, strokeWidth = Circle.defaultProps.strokeWidth, } = props;
