...
export class KagiSeries extends React.Component {
    constructor() {
        ...
        this.renderSVG = (moreProps) => {
            ...
            const { className, stroke = KagiSeries.defaultProps.stroke, fill = KagiSeries.defaultProps.fill, strokeWidth, } = this.props;
            const paths = helper(plotData, xAccessor)
                ...
                return (React.createElement("path", { key: i, d: data, className: each.type, stroke: stroke[each.type], fill: fill[each.type], strokeWidth: strokeWidth }));
            });
            return (React.createElement("g", { className: className }, paths));
        };
    ...
    render() {
        return (React.createElement(GenericChartComponent, { svgDraw: this.renderSVG, canvasToDraw: getAxisCanvas, canvasDraw: this.drawOnCanvas, drawOn: ["pan"] }));
    }
}
