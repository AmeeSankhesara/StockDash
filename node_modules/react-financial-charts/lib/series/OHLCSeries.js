...
export class OHLCSeries extends React.Component {
    constructor() {
        ...
        this.renderSVG = (moreProps) => {
            ...
            return (React.createElement("g", { className: className }, bars.map((d, idx) => React.createElement("path", { key: idx, className: d.className, stroke: d.stroke, strokeWidth: strokeWidth, d: `M${d.openX1} ${d.openY} L${d.openX2} ${d.openY} M${d.x} ${d.y1} L${d.x} ${d.y2} M${d.closeX1} ${d.closeY} L${d.closeX2} ${d.closeY}` }))));
        };
        ...
        this.getOHLCBars = (props, xAccessor, yAccessor, xScale, yScale, plotData) => {
    ...
    render() {
        ...
        return (React.createElement(GenericChartComponent, { svgDraw: this.renderSVG, canvasToDraw: getAxisCanvas, canvasDraw: this.drawOnCanvas, clip: clip, drawOn: ["pan"] }));
    }
}
