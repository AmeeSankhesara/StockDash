...
export class GroupTooltip extends React.Component {
    constructor() {
        ...
        this.renderSVG = (moreProps) => {
            ...
            return (React.createElement("g", { transform: `translate(${xPos}, ${yPos})`, className: className, textAnchor: textAnchor }, layout === "horizontalInline"
                ? React.createElement(ToolTipText, { x: 0, y: 0, fontFamily: fontFamily, fontSize: fontSize }, singleTooltip)
                : singleTooltip));
        };
    }
    render() {
