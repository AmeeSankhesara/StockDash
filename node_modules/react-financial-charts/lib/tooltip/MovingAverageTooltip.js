    ...
    constructor() {
        ...
        this.onClick = (event) => {
            ...
            if (onClick !== undefined) {
                onClick(Object.assign({ chartId: forChart }, options), event);
            }
        };
    }
    render() {
        ...
        return (React.createElement("g", { transform: translate },
            ...
            React.createElement(ToolTipText, { x: 5, y: 11, fontFamily: fontFamily, fontSize: fontSize },
                React.createElement(ToolTipTSpanLabel, { fill: labelFill }, displayName),
...
export class MovingAverageTooltip extends React.Component {
    constructor() {
        ...
        this.renderSVG = (moreProps) => {
            ...
            return (React.createElement("g", { transform: `translate(${ox + x}, ${oy + y})`, className: className }, options
                .map((each, idx) => {
                ...
                return (React.createElement(SingleMAToolTip, { key: idx, origin: [width * idx, 0], color: each.stroke, displayName: tooltipLabel, value: yDisplayValue, options: each, forChart: chartId, onClick: onClick, fontFamily: fontFamily, fontSize: fontSize, textFill: textFill, labelFill: labelFill }));
            })));
        };
    }
    render() {
